...
import {
    ResendSigningLink200ResponseFromJSON,
    ResendSigningLink200ResponseToJSON,
} from '../models/index';

export interface DownloadSignerSignatureRequest {
    id: string;
    sid: string;
}

export interface ResendSigningLinkRequest {
    id: string;
    sid: string;
}
 ...
 * 
 */
export class SignersApi extends runtime.BaseAPI {

    /**
     * Creates request options for downloadSignerSignature without sending the request
     */
    async downloadSignerSignatureRequestOpts(requestParameters: DownloadSignerSignatureRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling downloadSignerSignature().'
            );
        }
        ...
        if (requestParameters['sid'] == null) {
            throw new runtime.RequiredError(
                'sid',
                'Required parameter "sid" was null or undefined when calling downloadSignerSignature().'
            );
        }
        ...
        let urlPath = `/requests/{id}/signers/{sid}/signature`;
     ...
     */
    async downloadSignerSignatureRaw(requestParameters: DownloadSignerSignatureRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Blob>> {
        const requestOptions = await this.downloadSignerSignatureRequestOpts(requestParameters);
     ...
     * Download signer signature
     */
    async downloadSignerSignature(requestParameters: DownloadSignerSignatureRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Blob> {
        const response = await this.downloadSignerSignatureRaw(requestParameters, initOverrides);
        return await response.value();
    }

    /**
     * Creates request options for resendSigningLink without sending the request
     */
    async resendSigningLinkRequestOpts(requestParameters: ResendSigningLinkRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling resendSigningLink().'
            );
        }
        ...
        if (requestParameters['sid'] == null) {
            throw new runtime.RequiredError(
                'sid',
                'Required parameter "sid" was null or undefined when calling resendSigningLink().'
            );
        }
        ...
        let urlPath = `/requests/{id}/signers/{sid}/resend`;
        urlPath = urlPath.replace('{id}', encodeURIComponent(String(requestParameters['id'])));
        urlPath = urlPath.replace('{sid}', encodeURIComponent(String(requestParameters['sid'])));
     ...
     * Resend signing link
     */
    async resendSigningLinkRaw(requestParameters: ResendSigningLinkRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResendSigningLink200Response>> {
        const requestOptions = await this.resendSigningLinkRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ResendSigningLink200ResponseFromJSON(jsonValue));
    }
     ...
     * Resend signing link
     */
    async resendSigningLink(requestParameters: ResendSigningLinkRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResendSigningLink200Response> {
        const response = await this.resendSigningLinkRaw(requestParameters, initOverrides);
        return await response.value();
    }
