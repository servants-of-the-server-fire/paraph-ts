...
export function instanceOfSignerStatus(value: any): boolean {
    for (const key in SignerStatus) {
        if (Object.prototype.hasOwnProperty.call(SignerStatus, key)) {
            if (SignerStatus[key as keyof typeof SignerStatus] === value) {
                return true;
            }
        }
    }
...
export function SignerStatusFromJSON(json: any): SignerStatus {
    return SignerStatusFromJSONTyped(json, false);
}

export function SignerStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): SignerStatus {
    return json as SignerStatus;
}

export function SignerStatusToJSON(value?: SignerStatus | null): any {
    return value as any;
}

export function SignerStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): SignerStatus {
    return value as SignerStatus;
}
