 ...
 * 
 * Deliveries include an `X-Signature-256` header containing
 * `sha256=<hex>` where `<hex>` is the HMAC-SHA256 of the request
 * body using the webhook's secret as the key. Verify this to
 * confirm the delivery came from Paraph.
 * 
