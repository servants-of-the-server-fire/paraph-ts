 ...
 * 
 * @export
 * @interface ResendSigningLink200Response
 */
export interface ResendSigningLink200Response {
    /**
     * 
     * @type {Signer}
     * @memberof ResendSigningLink200Response
     */
    signer?: Signer;
}

/**
 * Check if a given object implements the ResendSigningLink200Response interface.
 */
export function instanceOfResendSigningLink200Response(value: object): value is ResendSigningLink200Response {
    return true;
}

export function ResendSigningLink200ResponseFromJSON(json: any): ResendSigningLink200Response {
    return ResendSigningLink200ResponseFromJSONTyped(json, false);
}

export function ResendSigningLink200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResendSigningLink200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function ResendSigningLink200ResponseToJSON(json: any): ResendSigningLink200Response {
    return ResendSigningLink200ResponseToJSONTyped(json, false);
}

export function ResendSigningLink200ResponseToJSONTyped(value?: ResendSigningLink200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
