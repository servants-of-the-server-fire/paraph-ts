...
export interface ErrorError {
    /**
     * 
     * @type {ErrorErrorErrorNameEnum}
     * @memberof ErrorError
     */
    error_name: ErrorErrorErrorNameEnum;
    /**
     * 
     * @type {string}
     * @memberof ErrorError
 ...
 * @export
 */
export const ErrorErrorErrorNameEnum = {
...
export type ErrorErrorErrorNameEnum = typeof ErrorErrorErrorNameEnum[keyof typeof ErrorErrorErrorNameEnum];
...
export function instanceOfErrorError(value: object): value is ErrorError {
    if (!('error_name' in value) || value['error_name'] === undefined) return false;
    if (!('error_msg' in value) || value['error_msg'] === undefined) return false;
    return true;
}
