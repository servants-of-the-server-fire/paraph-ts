...
import {
    ...
    AccountLimitsFromJSONTyped,
    AccountLimitsToJSON,
    AccountLimitsToJSONTyped,
} from './AccountLimits';
 ...
 * @export
 */
export const AccountPlanEnum = {
    free: 'free',
    pro: 'pro',
    enterprise: 'enterprise'
} as const;
export type AccountPlanEnum = typeof AccountPlanEnum[keyof typeof AccountPlanEnum];
