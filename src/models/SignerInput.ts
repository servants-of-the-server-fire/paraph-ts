...
/**
 * Check if a given object implements the SignerInput interface.
 */
export function instanceOfSignerInput(value: object): value is SignerInput {
    if (!('email' in value) || value['email'] === undefined) return false;
    return true;
}

export function SignerInputFromJSON(json: any): SignerInput {
    return SignerInputFromJSONTyped(json, false);
}

export function SignerInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): SignerInput {
    if (json == null) {
        return json;
    }
    return {
        ...
        'email': json['email'],
        'override_signature_url': json['override_signature_url'] == null ? undefined : json['override_signature_url'],
    };
}

export function SignerInputToJSON(json: any): SignerInput {
    return SignerInputToJSONTyped(json, false);
}

export function SignerInputToJSONTyped(value?: SignerInput | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'email': value['email'],
        'override_signature_url': value['override_signature_url'],
    };
}
