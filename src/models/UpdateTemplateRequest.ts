...
import type { SignaturePlacementInput } from './SignaturePlacementInput';
import {
    SignaturePlacementInputFromJSON,
    SignaturePlacementInputFromJSONTyped,
    SignaturePlacementInputToJSON,
    SignaturePlacementInputToJSONTyped,
} from './SignaturePlacementInput';
...
export interface UpdateTemplateRequest {
     ...
     * @type {Array<SignaturePlacementInput>}
     * @memberof UpdateTemplateRequest
     */
    signature_placements?: Array<SignaturePlacementInput>;
}
...
export function UpdateTemplateRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateTemplateRequest {
    ...
    return {
        ...
        'signature_placements': json['signature_placements'] == null ? undefined : ((json['signature_placements'] as Array<any>).map(SignaturePlacementInputFromJSON)),
    };
}
...
export function UpdateTemplateRequestToJSONTyped(value?: UpdateTemplateRequest | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'signature_placements': value['signature_placements'] == null ? undefined : ((value['signature_placements'] as Array<any>).map(SignaturePlacementInputToJSON)),
    };
}
