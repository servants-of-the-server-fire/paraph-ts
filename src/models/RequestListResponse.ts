...
import type { DocumentRequestSummary } from './DocumentRequestSummary';
import {
    DocumentRequestSummaryFromJSON,
    DocumentRequestSummaryFromJSONTyped,
    DocumentRequestSummaryToJSON,
    DocumentRequestSummaryToJSONTyped,
} from './DocumentRequestSummary';
...
export interface RequestListResponse {
    /**
     * 
     * @type {Array<DocumentRequestSummary>}
     * @memberof RequestListResponse
     */
    requests?: Array<DocumentRequestSummary>;
    /**
     * 
     * @type {ListInfo}
     * @memberof RequestListResponse
...
/**
 * Check if a given object implements the RequestListResponse interface.
 */
export function instanceOfRequestListResponse(value: object): value is RequestListResponse {
    return true;
}

export function RequestListResponseFromJSON(json: any): RequestListResponse {
    return RequestListResponseFromJSONTyped(json, false);
}

export function RequestListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RequestListResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'requests': json['requests'] == null ? undefined : ((json['requests'] as Array<any>).map(DocumentRequestSummaryFromJSON)),
        'list_info': json['list_info'] == null ? undefined : ListInfoFromJSON(json['list_info']),
    };
}

export function RequestListResponseToJSON(json: any): RequestListResponse {
    return RequestListResponseToJSONTyped(json, false);
}

export function RequestListResponseToJSONTyped(value?: RequestListResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'requests': value['requests'] == null ? undefined : ((value['requests'] as Array<any>).map(DocumentRequestSummaryToJSON)),
        'list_info': ListInfoToJSON(value['list_info']),
    };
}
