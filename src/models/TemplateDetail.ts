...
import {
    SignaturePlacementFromJSON,
    SignaturePlacementFromJSONTyped,
    SignaturePlacementToJSON,
    SignaturePlacementToJSONTyped,
...
export interface TemplateDetail {
     ...
     * @type {Array<SignaturePlacement>}
     * @memberof TemplateDetail
     */
    signature_placements: Array<SignaturePlacement>;
}
...
export function instanceOfTemplateDetail(value: object): value is TemplateDetail {
    ...
    if (!('signature_placements' in value) || value['signature_placements'] === undefined) return false;
    return true;
}
...
export function TemplateDetailFromJSONTyped(json: any, ignoreDiscriminator: boolean): TemplateDetail {
    ...
    return {
        ...
        'signature_placements': ((json['signature_placements'] as Array<any>).map(SignaturePlacementFromJSON)),
    };
}

export function TemplateDetailToJSON(json: any): TemplateDetail {
    return TemplateDetailToJSONTyped(json, false);
}

export function TemplateDetailToJSONTyped(value?: TemplateDetail | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'signature_placements': ((value['signature_placements'] as Array<any>).map(SignaturePlacementToJSON)),
    };
}
