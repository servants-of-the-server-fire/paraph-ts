...
/**
 * Check if a given object implements the SignaturePlacement interface.
 */
export function instanceOfSignaturePlacement(value: object): value is SignaturePlacement {
...
export function SignaturePlacementFromJSON(json: any): SignaturePlacement {
    return SignaturePlacementFromJSONTyped(json, false);
}

export function SignaturePlacementFromJSONTyped(json: any, ignoreDiscriminator: boolean): SignaturePlacement {
    if (json == null) {
        return json;
    }
    return {
...
export function SignaturePlacementToJSON(json: any): SignaturePlacement {
    return SignaturePlacementToJSONTyped(json, false);
}

export function SignaturePlacementToJSONTyped(value?: SignaturePlacement | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
