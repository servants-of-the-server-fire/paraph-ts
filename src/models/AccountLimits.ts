...
export function instanceOfAccountLimits(value: object): value is AccountLimits {
    if (!('requests_per_month' in value) || value['requests_per_month'] === undefined) return false;
    if (!('signing_requests_per_month' in value) || value['signing_requests_per_month'] === undefined) return false;
    if (!('max_templates' in value) || value['max_templates'] === undefined) return false;
    if (!('max_members' in value) || value['max_members'] === undefined) return false;
    return true;
}
...
export function AccountLimitsFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountLimits {
    ...
    return {
        ...
        'requests_per_month': json['requests_per_month'],
        'signing_requests_per_month': json['signing_requests_per_month'],
        'max_templates': json['max_templates'],
...
export function AccountLimitsToJSONTyped(value?: AccountLimits | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'signing_requests_per_month': value['signing_requests_per_month'],
