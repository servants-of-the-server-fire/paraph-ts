...
/**
 * Check if a given object implements the WebhookDeliveryData interface.
 */
export function instanceOfWebhookDeliveryData(value: object): value is WebhookDeliveryData {
    return true;
}

export function WebhookDeliveryDataFromJSON(json: any): WebhookDeliveryData {
    return WebhookDeliveryDataFromJSONTyped(json, false);
}

export function WebhookDeliveryDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): WebhookDeliveryData {
    if (json == null) {
        return json;
    }
    return {
        ...
        'signer_id': json['signer_id'] == null ? undefined : json['signer_id'],
        'signer_label': json['signer_label'] == null ? undefined : json['signer_label'],
        'recipient_email': json['recipient_email'] == null ? undefined : json['recipient_email'],
    };
}

export function WebhookDeliveryDataToJSON(json: any): WebhookDeliveryData {
    return WebhookDeliveryDataToJSONTyped(json, false);
}

export function WebhookDeliveryDataToJSONTyped(value?: WebhookDeliveryData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
