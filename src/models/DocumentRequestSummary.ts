...
export interface DocumentRequestSummary {
     ...
     * 
     * @type {string}
     * @memberof DocumentRequestSummary
     */
    id: string;
    /**
     * 
...
/**
 * Check if a given object implements the DocumentRequestSummary interface.
 */
export function instanceOfDocumentRequestSummary(value: object): value is DocumentRequestSummary {
    if (!('id' in value) || value['id'] === undefined) return false;
    if (!('template_id' in value) || value['template_id'] === undefined) return false;
    if (!('status' in value) || value['status'] === undefined) return false;
    if (!('has_signing' in value) || value['has_signing'] === undefined) return false;
    if (!('created_at' in value) || value['created_at'] === undefined) return false;
    if (!('updated_at' in value) || value['updated_at'] === undefined) return false;
    return true;
}

export function DocumentRequestSummaryFromJSON(json: any): DocumentRequestSummary {
    return DocumentRequestSummaryFromJSONTyped(json, false);
}

export function DocumentRequestSummaryFromJSONTyped(json: any, ignoreDiscriminator: boolean): DocumentRequestSummary {
    if (json == null) {
        return json;
    }
    return {
        ...
        'has_signing': json['has_signing'],
        'created_at': (new Date(json['created_at'])),
        'updated_at': (new Date(json['updated_at'])),
    };
}

export function DocumentRequestSummaryToJSON(json: any): DocumentRequestSummary {
    return DocumentRequestSummaryToJSONTyped(json, false);
}

export function DocumentRequestSummaryToJSONTyped(value?: DocumentRequestSummary | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
