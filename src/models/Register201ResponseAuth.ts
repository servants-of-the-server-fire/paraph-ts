 ...
 * 
 * @export
 * @interface Register201ResponseAuth
 */
export interface Register201ResponseAuth {
    /**
     * 
     * @type {string}
     * @memberof Register201ResponseAuth
     */
    message: string;
}

/**
 * Check if a given object implements the Register201ResponseAuth interface.
 */
export function instanceOfRegister201ResponseAuth(value: object): value is Register201ResponseAuth {
    if (!('message' in value) || value['message'] === undefined) return false;
    return true;
}

export function Register201ResponseAuthFromJSON(json: any): Register201ResponseAuth {
    return Register201ResponseAuthFromJSONTyped(json, false);
}

export function Register201ResponseAuthFromJSONTyped(json: any, ignoreDiscriminator: boolean): Register201ResponseAuth {
    if (json == null) {
        return json;
    }
    return {
...
export function Register201ResponseAuthToJSON(json: any): Register201ResponseAuth {
    return Register201ResponseAuthToJSONTyped(json, false);
}

export function Register201ResponseAuthToJSONTyped(value?: Register201ResponseAuth | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
