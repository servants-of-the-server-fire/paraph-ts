...
import {
    SignerStatusFromJSON,
    SignerStatusFromJSONTyped,
    SignerStatusToJSON,
    SignerStatusToJSONTyped,
} from './SignerStatus';
...
export function instanceOfSigner(value: object): value is Signer {
    ...
    if (!('recipient_email' in value) || value['recipient_email'] === undefined) return false;
...
export function SignerFromJSONTyped(json: any, ignoreDiscriminator: boolean): Signer {
    ...
    return {
        ...
        'status': SignerStatusFromJSON(json['status']),
        'expires_at': json['expires_at'] == null ? undefined : (new Date(json['expires_at'])),
        'signed_at': json['signed_at'] == null ? undefined : (new Date(json['signed_at'])),
    };
}
...
export function SignerToJSONTyped(value?: Signer | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'status': SignerStatusToJSON(value['status']),
        'expires_at': value['expires_at'] == null ? value['expires_at'] : value['expires_at'].toISOString(),
        'signed_at': value['signed_at'] == null ? value['signed_at'] : value['signed_at'].toISOString(),
    };
}
